...
{
    public partial class Northwind_88_EHContext : DbContext
    {
        public Northwind_88_EHContext()
        {
        }

        public Northwind_88_EHContext(DbContextOptions<Northwind_88_EHContext> options)
            : base(options)
        {
        }
